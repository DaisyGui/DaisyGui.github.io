...
This boxplot below shows numbers of reviews of airbnb with >30 reveiws in different neighbourhoods in Bronx. 

```{r}
high_review = filter(airbnb_df, number_of_reviews > 30)
